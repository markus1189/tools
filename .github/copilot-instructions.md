...
1. **CDN URLs and SRI hashes**: Verify URLs are valid and integrity hashes match
...
4. **Changelog**: Ensure CHANGELOG.md is updated for user-facing changes
5. **tools.json**: For new tools or updates, verify entry is correct and complete
